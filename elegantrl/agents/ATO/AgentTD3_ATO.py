import torch
from elegantrl.agents.ATO.net_ATO import Actor, CriticTwin
from elegantrl.agents.ATO.AgentDDPG_ATO import AgentDDPG_ATO
from elegantrl.envs.ATO_env.gym_utils import projection_function, penalty_func


class AgentTD3_ATO(AgentDDPG_ATO):
    """
    Bases: ``AgentBase``
    ...
    def update_net(self, buffer) -> tuple:
        ...
        for update_c in range(
            ...
            '''update the second time by feasible action'''
