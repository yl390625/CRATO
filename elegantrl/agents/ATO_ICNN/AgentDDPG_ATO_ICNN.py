from elegantrl.agents.ATO_ICNN.net_ATO_ICNN import (
    ActorICNN,
    CriticTwinICNN,
)
from elegantrl.agents.ATO_ICNN.AgentBase_ATO_ICNN import AgentBase_ATO_ICNN


class AgentDDPG_ATO_ICNN(AgentBase_ATO_ICNN):
    """
    Bases: ``AgentBase``
