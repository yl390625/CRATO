...
class Arguments:
    def __init__(self, agent, env=None, env_func=None, env_args=None, ATOConfig = None):
        self.ATOConfig = ATOConfig
        ...
        self.thread_num = (
            32  # cpu_num for pytorch, `torch.set_num_threads(self.num_threads)`
        )
