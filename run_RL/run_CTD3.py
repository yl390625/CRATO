...
def main():
    parser = argparse.ArgumentParser(description="Train data-driven CTD3 algorithm.")
    ...
    agent = AgentTD3_ATO_ICNN.AgentTD3_ATO_ICNN
    ...
    rl_args.cwd = f"models/CTD3_{config_filename}_datasize{num}_date{now.strftime("%Y%m%d")}"
